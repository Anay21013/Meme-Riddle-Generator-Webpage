...
function clearAll() {
    const memecnt = document.querySelector('.meme');
    const jokecnt = document.querySelector('.joke');
    const quotecnt = document.querySelector('.quote');
    const riddlecnt = document.querySelector('.riddle');
    memecnt.innerHTML = '';
    jokecnt.innerHTML = '';
    quotecnt.innerHTML = '';
    riddlecnt.innerHTML = '';
...
function showMeme() {
    ...
    clearAll();
    document.querySelector('.meme').appendChild(Meme);
}
...
function showJoke() {
    ...
    clearAll();
    document.querySelector('.joke').appendChild(Joke);
}
...
function showQuote() {
    ...
    Q.textContent = randomQuote.quote;
    A.textContent = '-' + randomQuote.author;
    clearAll();
    document.querySelector('.quote').appendChild(Q);
    document.querySelector('.quote').appendChild(A);
}
...
function showRiddle() {
    ...
    R.textContent ='Answer: '+ answer;
    R.setAttribute('id','riddle-answer');
    R.hidden = true;
    clearAll();
...
function revealAnswers() {
    ...
    if(riddle && answer.hidden){
      ...
      alert("No riddle to show answer of!")
    }
}
